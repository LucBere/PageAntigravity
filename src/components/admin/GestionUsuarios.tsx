...
const mockUsers = [
  ...
  { id: 3, name: 'Julian Vane', email: 'j.vane@squatgym.com', role: 'Recepcionista', status: 'INACTIVO', lastConnection: '12 Oct, 2025', avatar: 'https://i.pravatar.cc/150?u=3' },
  ...
  { id: 7, name: 'Carlos Gomez', email: 'c.gomez@squatgym.com', role: 'Profesor', status: 'INACTIVO', lastConnection: '01 Nov, 2025', avatar: 'https://i.pravatar.cc/150?u=7' },
  ...
  { id: 12, name: 'Maria Torres', email: 'm.torres@squatgym.com', role: 'Administrador', status: 'INACTIVO', lastConnection: '15 Mar, 2025', avatar: 'https://i.pravatar.cc/150?u=12' },
  ...
  { id: 17, name: 'Raul Jimenez', email: 'r.jimenez@squatgym.com', role: 'Profesor', status: 'INACTIVO', lastConnection: '20 Jun, 2025', avatar: 'https://i.pravatar.cc/150?u=17' },
