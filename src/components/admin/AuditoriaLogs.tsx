...
const allLogs = [
  { id: 1, usuario: 'Admin_Mario', ip: '192.168.1.42', avatar: 'AM', avatarBg: 'bg-green-100 text-green-700 dark:bg-[#1B2A1E] dark:text-[#4ADE80]', accion: 'ELIMINACIÓN DE USUARIO', actionBg: 'bg-red-50 text-red-600 border border-red-200 dark:bg-red-950/30 dark:text-red-500 dark:border-red-900/50', modulo: 'Gestión Clientes', fechaHora: '14 May, 2026\n14:22:05', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 2, usuario: 'Lucia_Rec', ip: '192.168.1.15', avatar: 'LR', avatarBg: 'bg-green-100 text-green-700 dark:bg-[#1B2A1E] dark:text-[#4ADE80]', accion: 'CAMBIO DE PASSWORD', actionBg: 'bg-slate-100 text-slate-700 border border-slate-300 dark:bg-zinc-800 dark:text-white dark:border-zinc-700', modulo: 'Perfil', fechaHora: '14 May, 2026\n13:45:12', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 3, usuario: 'Anónimo', ip: '201.24.11.90', avatar: '?', avatarBg: 'bg-red-100 text-red-600 dark:bg-red-900/40 dark:text-red-500', accion: 'FALLA DE LOGIN', actionBg: 'bg-orange-50 text-orange-600 border border-orange-200 dark:bg-orange-950/50 dark:text-orange-500 dark:border-orange-900/50', modulo: 'Auth System', fechaHora: '14 May, 2026\n12:10:59', estado: 'BLOQUEADO', statusColor: 'bg-red-500', isAlert: true },
  { id: 4, usuario: 'SuperAdmin', ip: '127.0.0.1', avatar: 'SA', avatarBg: 'bg-yellow-100 text-yellow-700 dark:bg-[#3A2D12] dark:text-[#FBBF24]', accion: 'PAGO REGISTRADO', actionBg: 'bg-green-50 text-green-600 border border-green-200 dark:bg-green-950/30 dark:text-green-500 dark:border-green-900/50', modulo: 'Finanzas', fechaHora: '14 May, 2026\n09:30:00', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 5, usuario: 'Admin_Mario', ip: '192.168.1.42', avatar: 'AM', avatarBg: 'bg-green-100 text-green-700 dark:bg-[#1B2A1E] dark:text-[#4ADE80]', accion: 'NUEVO INGRESO', actionBg: 'bg-blue-50 text-blue-600 border border-blue-200 dark:bg-blue-950/30 dark:text-blue-500 dark:border-blue-900/50', modulo: 'Auth System', fechaHora: '13 May, 2026\n18:15:22', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 6, usuario: 'Lucia_Rec', ip: '192.168.1.15', avatar: 'LR', avatarBg: 'bg-green-100 text-green-700 dark:bg-[#1B2A1E] dark:text-[#4ADE80]', accion: 'PAGO REGISTRADO', actionBg: 'bg-green-50 text-green-600 border border-green-200 dark:bg-green-950/30 dark:text-green-500 dark:border-green-900/50', modulo: 'Finanzas', fechaHora: '13 May, 2026\n17:40:10', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 7, usuario: 'Anónimo', ip: '10.0.0.5', avatar: '?', avatarBg: 'bg-red-100 text-red-600 dark:bg-red-900/40 dark:text-red-500', accion: 'FALLA DE LOGIN', actionBg: 'bg-orange-50 text-orange-600 border border-orange-200 dark:bg-orange-950/50 dark:text-orange-500 dark:border-orange-900/50', modulo: 'Auth System', fechaHora: '13 May, 2026\n15:20:00', estado: 'FALLA', statusColor: 'bg-orange-500', isAlert: true },
  { id: 8, usuario: 'SuperAdmin', ip: '127.0.0.1', avatar: 'SA', avatarBg: 'bg-yellow-100 text-yellow-700 dark:bg-[#3A2D12] dark:text-[#FBBF24]', accion: 'ELIMINACIÓN DE USUARIO', actionBg: 'bg-red-50 text-red-600 border border-red-200 dark:bg-red-950/30 dark:text-red-500 dark:border-red-900/50', modulo: 'Gestión Clientes', fechaHora: '13 May, 2026\n11:10:05', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 9, usuario: 'Admin_Mario', ip: '192.168.1.42', avatar: 'AM', avatarBg: 'bg-green-100 text-green-700 dark:bg-[#1B2A1E] dark:text-[#4ADE80]', accion: 'CAMBIO DE PASSWORD', actionBg: 'bg-slate-100 text-slate-700 border border-slate-300 dark:bg-zinc-800 dark:text-white dark:border-zinc-700', modulo: 'Perfil', fechaHora: '10 Mar, 2026\n09:05:11', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 10, usuario: 'Lucia_Rec', ip: '192.168.1.15', avatar: 'LR', avatarBg: 'bg-green-100 text-green-700 dark:bg-[#1B2A1E] dark:text-[#4ADE80]', accion: 'NUEVO INGRESO', actionBg: 'bg-blue-50 text-blue-600 border border-blue-200 dark:bg-blue-950/30 dark:text-blue-500 dark:border-blue-900/50', modulo: 'Auth System', fechaHora: '10 Mar, 2026\n08:30:00', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 11, usuario: 'SuperAdmin', ip: '127.0.0.1', avatar: 'SA', avatarBg: 'bg-yellow-100 text-yellow-700 dark:bg-[#3A2D12] dark:text-[#FBBF24]', accion: 'NUEVO INGRESO', actionBg: 'bg-blue-50 text-blue-600 border border-blue-200 dark:bg-blue-950/30 dark:text-blue-500 dark:border-blue-900/50', modulo: 'Auth System', fechaHora: '15 Jan, 2026\n19:45:00', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 12, usuario: 'Anónimo', ip: '172.16.0.10', avatar: '?', avatarBg: 'bg-red-100 text-red-600 dark:bg-red-900/40 dark:text-red-500', accion: 'FALLA DE LOGIN', actionBg: 'bg-orange-50 text-orange-600 border border-orange-200 dark:bg-orange-950/50 dark:text-orange-500 dark:border-orange-900/50', modulo: 'Auth System', fechaHora: '15 Jan, 2026\n16:15:33', estado: 'BLOQUEADO', statusColor: 'bg-red-500', isAlert: true },
  { id: 13, usuario: 'Lucia_Rec', ip: '192.168.1.15', avatar: 'LR', avatarBg: 'bg-green-100 text-green-700 dark:bg-[#1B2A1E] dark:text-[#4ADE80]', accion: 'PAGO REGISTRADO', actionBg: 'bg-green-50 text-green-600 border border-green-200 dark:bg-green-950/30 dark:text-green-500 dark:border-green-900/50', modulo: 'Finanzas', fechaHora: '15 Jan, 2026\n14:20:10', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 14, usuario: 'Admin_Mario', ip: '192.168.1.42', avatar: 'AM', avatarBg: 'bg-green-100 text-green-700 dark:bg-[#1B2A1E] dark:text-[#4ADE80]', accion: 'ELIMINACIÓN DE USUARIO', actionBg: 'bg-red-50 text-red-600 border border-red-200 dark:bg-red-950/30 dark:text-red-500 dark:border-red-900/50', modulo: 'Gestión Clientes', fechaHora: '02 Nov, 2025\n10:05:00', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 15, usuario: 'Anónimo', ip: '192.168.1.100', avatar: '?', avatarBg: 'bg-red-100 text-red-600 dark:bg-red-900/40 dark:text-red-500', accion: 'FALLA DE LOGIN', actionBg: 'bg-orange-50 text-orange-600 border border-orange-200 dark:bg-orange-950/50 dark:text-orange-500 dark:border-orange-900/50', modulo: 'Auth System', fechaHora: '02 Nov, 2025\n09:12:45', estado: 'FALLA', statusColor: 'bg-orange-500', isAlert: true },
  { id: 16, usuario: 'SuperAdmin', ip: '127.0.0.1', avatar: 'SA', avatarBg: 'bg-yellow-100 text-yellow-700 dark:bg-[#3A2D12] dark:text-[#FBBF24]', accion: 'CAMBIO DE PASSWORD', actionBg: 'bg-slate-100 text-slate-700 border border-slate-300 dark:bg-zinc-800 dark:text-white dark:border-zinc-700', modulo: 'Perfil', fechaHora: '20 Sep, 2025\n18:30:20', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 17, usuario: 'Lucia_Rec', ip: '192.168.1.15', avatar: 'LR', avatarBg: 'bg-green-100 text-green-700 dark:bg-[#1B2A1E] dark:text-[#4ADE80]', accion: 'NUEVO INGRESO', actionBg: 'bg-blue-50 text-blue-600 border border-blue-200 dark:bg-blue-950/30 dark:text-blue-500 dark:border-blue-900/50', modulo: 'Auth System', fechaHora: '20 Sep, 2025\n08:00:10', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 18, usuario: 'Admin_Mario', ip: '192.168.1.42', avatar: 'AM', avatarBg: 'bg-green-100 text-green-700 dark:bg-[#1B2A1E] dark:text-[#4ADE80]', accion: 'PAGO REGISTRADO', actionBg: 'bg-green-50 text-green-600 border border-green-200 dark:bg-green-950/30 dark:text-green-500 dark:border-green-900/50', modulo: 'Finanzas', fechaHora: '05 Jul, 2025\n15:45:00', estado: 'Éxito', statusColor: 'bg-green-500 dark:bg-[#4ADE80]', isAlert: false },
  { id: 19, usuario: 'Anónimo', ip: '8.8.8.8', avatar: '?', avatarBg: 'bg-red-100 text-red-600 dark:bg-red-900/40 dark:text-red-500', accion: 'FALLA DE LOGIN', actionBg: 'bg-orange-50 text-orange-600 border border-orange-200 dark:bg-orange-950/50 dark:text-orange-500 dark:border-orange-900/50', modulo: 'Auth System', fechaHora: '05 Jul, 2025\n03:22:15', estado: 'BLOQUEADO', statusColor: 'bg-red-500', isAlert: true },
